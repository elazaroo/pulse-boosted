 ...
 * @method static \Elazaroo\PulseBoosted\Pulse rejectTraceEvents(string $type, callable $callback)
 * @method static \Elazaroo\PulseBoosted\Pulse redactTraceEvents(string $type, callable $callback)
 * @method static \Elazaroo\PulseBoosted\Pulse rejectQueries(callable $callback)
 * @method static \Elazaroo\PulseBoosted\Pulse rejectCacheKeys(array $patterns)
 * @method static \Elazaroo\PulseBoosted\Pulse rejectOutgoingRequests(callable $callback)
 * @method static \Elazaroo\PulseBoosted\Pulse rejectMail(callable $callback)
 * @method static \Elazaroo\PulseBoosted\Pulse rejectNotifications(callable $callback)
 * @method static \Elazaroo\PulseBoosted\Pulse rejectQueuedJobs(callable $callback)
 * @method static \Elazaroo\PulseBoosted\Pulse redactQueries(callable $callback)
 * @method static \Elazaroo\PulseBoosted\Pulse redactOutgoingRequests(callable $callback)
